// ---------------------------------------------------------------------------
// Data for FrenchDrill — extracted from FrenchDrill.jsx for readability.
// ---------------------------------------------------------------------------
...
// ── French conjugations (present indicative, 9 subjects) ────────────────────
// Index order mirrors SUBJECTS: Je Tu Il Elle On Nous Vous Ils Elles

export const CONJUGATIONS_FR = {
...
// ── Spanish equivalents (same slot layout as CONJUGATIONS_FR) ───────────────

export const CONJUGATIONS_ES = {
...
// ── Predicates (complements keyed by verb infinitive) ───────────────────────
// Each predicate may have gendered/plural forms: frF, frP, frFP, esF, esP, esFP.
// If absent, the base fr/es form is used for all subjects.
...
// ── Verb metadata (Spanish gloss + emoji) ───────────────────────────────────
...
// ── Daily verb pairs (35 days = 5 weeks × 7 days) ───────────────────────────

export const PAIRS = [
  ["etre","avoir"],       ["aller","faire"],      ["pouvoir","vouloir"],  ["savoir","devoir"],    ["dire","voir"],
  ["prendre","venir"],    ["mettre","partir"],
  ["finir","sortir"],     ["parler","manger"],    ["aimer","penser"],     ["trouver","donner"],   ["laisser","croire"],
  ["comprendre","entendre"], ["attendre","rester"],
  ["passer","tenir"],     ["porter","arriver"],   ["chercher","appeler"], ["demander","repondre"], ["montrer","ecrire"],
  ["lire","ouvrir"],      ["fermer","jouer"],
  ["gagner","travailler"], ["habiter","rencontrer"], ["inviter","choisir"], ["decider","rire"],   ["pleurer","chanter"],
  ["danser","conduire"],  ["voyager","acheter"],
  ["vendre","grandir"],   ["changer","dormir"],   ["reveiller","preparer"], ["cuisiner","marcher"], ["courir","tomber"],
  ["monter","partir"],    ["etre","avoir"],
];

// ── Tips shown on each day's info card ──────────────────────────────────────
...
// ── Calendar display data (7 days of the week) ──────────────────────────────

export const DAY_NAMES  = ["Domingo","Lunes","Martes","Miércoles","Jueves","Viernes","Sábado"];
export const DAY_EMOJIS = ["☀️","🔴","🟠","🟡","🟢","🟣","🩷"];
export const DAY_COLORS = ["#FDCB6E","#FF6B6B","#FF9F43","#FECA57","#1DD1A1","#A29BFE","#FD79A8"];
